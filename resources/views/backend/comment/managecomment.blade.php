...
<html lang="en">
     ...
     <div class="container-fluid fixed-top">
            <div class="container px-0">
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    <a href="index.html" class="navbar-brand"><h1 class="text-primary display-6">{{ $_SESSION['setting']->name ? $_SESSION['setting']->name :'' }}</h1></a>
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="shop-detail.html" class="nav-item nav-link">Business</a>
                    ...
                    <div class="col-lg-8 col-xl-9">
                        <div class="row g-4">
                            ...
                            <div class="col-lg-12">
                                ...
                                <form action='{{ route("news.mail", $news->id)}}' method='POST'>
                                @csrf
                                <div class="tab-content mb-5">
                                    <div class="tab-pane active" id="nav-about" role="tabpanel" aria-labelledby="nav-about-tab">
                                      
                                        <p>{{$news->description}}</p>
                                        <iframe allow="autoplay" allowfullscreen="" frameborder="0" height="360" src="{{$news->link}}" width="640"></iframe>
    ...
    <script src="{{asset('lib/lightbox/js/lightbox.min.j')}}s"></script>
